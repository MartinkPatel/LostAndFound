...
import com.martin_kirtan.lostandfound.databinding.ActivityPostLostItem2Binding
...
class PostLostItem : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.btnSubmit.setOnClickListener{
            ...
            mFirestore.collection(Constants.USERS).document(userID).collection("Lost Items").document(filename)
                .set(data)
            mFirestore.collection("Lost Items").document(filename).set(data)
